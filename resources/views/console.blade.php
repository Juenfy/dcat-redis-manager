...
@section('page')
    ...
    <script>
        ...
        $(function () {
            ...
            var send = function () {
                ...
                $.ajax({
                    url: '{{ admin_route('redis-execute', ['conn' => $conn]) }}',
                    method: 'post',
                    data: {
                        conn: '{{ $conn }}',
                        command: $input.val(),
                    ...
                    success: function (response) {
                        ...
                        $('#console-box')
                            .append('<div class="item"><small class="label label-default">{{ $conn }}  > '+$input.val()+'<\/small><\/div>')
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Redis Console</h3>
